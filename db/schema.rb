...
ActiveRecord::Schema.define(version: 20180105174917) do
  ...
  create_table "admin_users_pages_joins", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer "admin_user_id"
    t.integer "page_id"
  end
